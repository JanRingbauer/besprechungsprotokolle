		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atclouddnabesprechungsprotokolle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnabesprechungsprotokolle-display": {
								"semanticObject": "atclouddnabesprechungsprotokolle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.besprechungsprotokolle",
									"url": sap.ui.require.toUrl("at/clouddna/besprechungsprotokolle")
								}
							}
						}
					}
